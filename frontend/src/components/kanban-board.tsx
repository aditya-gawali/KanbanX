...
export default function KanbanBoard() {
    ...
    const addRule = (rule: Rule) => {
        setRules([...rules, rule])
        toast.success(`"${rule.name}" has been added`)
    }
    ...
    const deleteRule = (ruleId: string) => {
        ...
        toast.success("The automation rule has been deleted")
    }
    ...
    return (
        <div className="flex flex-col h-screen bg-slate-50 dark:bg-gray-950">
            <header className="bg-white dark:bg-gray-950 border-b dark:border-gray-700 p-4 shadow-sm">
